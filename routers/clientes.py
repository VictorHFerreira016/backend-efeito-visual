...
def atualizar(
    ...
    # Substitui endereços: o cascade="all, delete-orphan" no model
    # garante que os antigos sejam deletados ao reatribuir a lista
    cliente.enderecos = [Endereco(**e.model_dump()) for e in data.enderecos]
    cliente.telefones = [Telefone(**t.model_dump()) for t in data.telefones]
